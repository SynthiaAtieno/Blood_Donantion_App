...
public class Recipient_Registarion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipient_registarion);
        ...
        register_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bloodgroup.equals("Select Your Blood Group")) {
                    Toast.makeText(Recipient_Registarion.this, "Please select your blood group", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                            ...
                            new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        ...
                                        Toast.makeText(Recipient_Registarion.this, "Error " + error, Toast.LENGTH_SHORT).show();
                                    } else {
                                        ...
                                        userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(
                                                new OnCompleteListener() {
                                                    ...
                                                    public void onComplete(@NonNull Task task) {
                                                        if (task.isSuccessful()) {
                                                            Toast.makeText(Recipient_Registarion.this, "Data set Successfully", Toast.LENGTH_SHORT).show();
                                                        } else {
                                                            Toast.makeText(Recipient_Registarion.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                        }
                                                        finish();
                                        ...
                                        if (resultUri != null) {
                                            ...
                                            uploadTask.addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(Recipient_Registarion.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                                        ...
                                                        result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                            ...
                                                            public void onSuccess(Uri uri) {
                                                                ...
                                                                userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                                    ...
                                                                    public void onComplete(@NonNull Task task) {
                                                                        if (task.isSuccessful()) {
                                                                            Toast.makeText(Recipient_Registarion.this, "Image added succsessfully", Toast.LENGTH_SHORT).show();
                                                                        } else {
                                                                            Toast.makeText(Recipient_Registarion.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    }
                                            ...
                                            startActivity(new Intent(Recipient_Registarion.this, MainActivity.class));
                                            finish();
                                            progressDialog.dismiss();
